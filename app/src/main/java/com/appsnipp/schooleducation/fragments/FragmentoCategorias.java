package com.appsnipp.schooleducation.fragments;
...
import com.appsnipp.schooleducation.adapters.AdapterCategories;


/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link FragmentoCategorias.OnFragmentInteractionListener} interface
...
//    private OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] dataArray = this.getContext().getResources().getStringArray(R.array.entradas_categoria);

        AdapterCategories adaptador = new AdapterCategories( this.getContext(), dataArray);
